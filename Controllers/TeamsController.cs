...
namespace SRHLStats2020.Controllers
{
    public class TeamsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Team.Include(t => t.Club);
        ...
        public async Task<IActionResult> Create([Bind("Id,TeamName,ClubId")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TeamName,ClubId")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
